...
An alternative would be to use another weather API such as the [APIXU](https://www.apixu.com/api.aspx) weather app, but ##### I recomend downloading the app from Codepen or Github an running it from your own browser. 
